      ...
      <header className="fixed bg-white w-full dark:bg-gray-900 bg-opacity-90 dark:bg-opacity-80 backdrop-blur-xl ">
        ...
        >
          ...
          >
            <button
              type="button"
              className="inline-flex w-[20%] justify-center items-center px-4 py-2 text-sm font-medium text-gray-400 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 bg-opacity-50"
            >
              <svg
            ...
            <button
              type="button"
              className="inline-flex w-[20%] justify-center items-center px-4 py-2 text-sm font-medium text-gray-400 bold rounded-lg hover:bg-gray-100 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 bg-opacity-50"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
