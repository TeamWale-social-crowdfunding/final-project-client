  ...
  return (
    <div className=" z-20 fixed w-full chat-header px-6 py-2 flex flex-row flex-none justify-between items-center shadow bg-white text-gray-800 dark:bg-gray-800 dark:text-white">
      ...
      <div className="flex">
        <a
          href="#"
          className="block rounded-full hover:bg-gray-200 bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-600 w-10 h-10 p-2"
        >
          <svg
            viewBox="0 0 20 20"
            className="w-full h-full fill-current text-gray-800 dark:text-white"
          >
        ...
        <a
          href="#"
          className="block rounded-full hover:bg-gray-200 bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-600 w-10 h-10 p-2 ml-4"
        >
          <svg
            viewBox="0 0 20 20"
            className="w-full h-full fill-current text-gray-800 dark:text-white"
