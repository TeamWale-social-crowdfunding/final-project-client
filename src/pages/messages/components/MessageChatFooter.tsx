...
const MessageChatFooter = () => {
  return (
    <div className=" pl-96 fixed bottom-0 right-0 bg-white dark:bg-gray-800 w-full chat-footer flex-none">
      <div className="flex flex-row items-center p-4">
        ...
        <div className="relative flex-grow">
          <label>
            <input
              className="rounded-full py-2 pl-3 pr-10 w-full border border-gray-200 focus:border-gray-200 bg-gray-100 focus:outline-none text-gray-800 focus:shadow-md transition duration-300 ease-in dark:bg-gray-700 dark:border-gray-500 dark:text-white"
              type="text"
              placeholder="Aa"
            />
            <button
